...
\begin{myframe}[Supply Chain challenge (3')]
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item One parameter $v$ (volatility) which control standard deviations
      \end{itemize}
...
\begin{myframe}[Results: other KPI's]
  ...
  \mytext[current][text]{\blockwidth}{anchor = north west,
    ...
    \begin{itemize}
      \item Real inventory is the main part of objective function
